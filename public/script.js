...
const contents = [
    ...
    },
    {
        ...
        content: '<p>Bem-vindos &agrave; nossa aula sobre a linguagem de programa&ccedil;&atilde;o C! Neste curso, vamos explorar os conceitos fundamentais da linguagem C, uma das mais antigas e influentes linguagens de programa&ccedil;&atilde;o. Se voc&ecirc; est&aacute; come&ccedil;ando sua jornada no mundo da programa&ccedil;&atilde;o ou buscando refor&ccedil;ar seus conhecimentos em C, este &eacute; o lugar certo para come&ccedil;ar.</p><ol><li><p><strong>O que &eacute; a Linguagem C?</strong> A linguagem C foi desenvolvida nos anos 1970 por Dennis Ritchie no Bell Labs. &Eacute; uma linguagem de baixo n&iacute;vel, pr&oacute;xima ao hardware, mas ainda assim possui elementos de alto n&iacute;vel. C &eacute; amplamente usada em sistemas operacionais, sistemas embarcados e aplica&ccedil;&otilde;es de alto desempenho devido &agrave; sua efici&ecirc;ncia e controle sobre os recursos de hardware.</p></li><li><p><strong>Principais Conceitos</strong></p></li></ol><p>a) <strong>Sintaxe B&aacute;sica:</strong> A sintaxe de C &eacute; a estrutura e as regras que definem como os programas s&atilde;o escritos e interpretados. Um programa C &eacute; composto por fun&ccedil;&otilde;es, e a fun&ccedil;&atilde;o principal &eacute; a <code>main()</code>, onde a execu&ccedil;&atilde;o come&ccedil;a.</p><div class="dark bg-gray-950 rounded-md border-[0.5px] border-token-border-medium"><div class="overflow-y-auto p-4" dir="ltr"><code class="!whitespace-pre hljs language-c"><span class="hljs-meta">#<span class="hljs-keyword">include</span> <span class="hljs-string">&lt;stdio.h&gt;</span></span> <span class="hljs-type">int</span> <span class="hljs-title function_">main</span><span class="hljs-params">()</span> { <span class="hljs-built_in">printf</span>(<span class="hljs-string">"Ol&aacute;, Mundo!\n"</span>); <span class="hljs-keyword">return</span> <span class="hljs-number">0</span>; } </code></div></div><p>b) <strong>Vari&aacute;veis e Tipos de Dados:</strong> Em C, voc&ecirc; precisa declarar o tipo de dado que a vari&aacute;vel vai armazenar antes de us&aacute;-la. Os principais tipos de dados incluem <code>int</code> (inteiro), <code>float</code> (ponto flutuante), <code>char</code> (caractere) e <code>double</code> (ponto flutuante de precis&atilde;o dupla).</p><div class="dark bg-gray-950 rounded-md border-[0.5px] border-token-border-medium"><div class="overflow-y-auto p-4" dir="ltr"><code class="!whitespace-pre hljs language-c"><span class="hljs-type">int</span> idade = <span class="hljs-number">18</span>; <span class="hljs-type">float</span> altura = <span class="hljs-number">1.75</span>; <span class="hljs-type">char</span> letra = <span class="hljs-string">A</span>; </code></div></div><p>c) <strong>Estruturas de Controle de Fluxo:</strong> C possui estruturas de controle como <code>if</code>, <code>else</code>, <code>switch</code> para tomadas de decis&atilde;o, e <code>for</code>, <code>while</code>, <code>do-while</code> para repeti&ccedil;&atilde;o.</p><div class="dark bg-gray-950 rounded-md border-[0.5px] border-token-border-medium"><div class="overflow-y-auto p-4" dir="ltr"><code class="!whitespace-pre hljs language-c"><span class="hljs-keyword">if</span> (idade &gt;= <span class="hljs-number">18</span>) { <span class="hljs-built_in">printf</span>(<span class="hljs-string">"Maior de idade.\n"</span>); } <span class="hljs-keyword">else</span> { <span class="hljs-built_in">printf</span>(<span class="hljs-string">"Menor de idade.\n"</span>); } <span class="hljs-keyword">for</span> (<span class="hljs-type">int</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-number">10</span>; i++) { <span class="hljs-built_in">printf</span>(<span class="hljs-string">"%d\n"</span>, i); } </code></div></div><p>d) <strong>Fun&ccedil;&otilde;es:</strong> Fun&ccedil;&otilde;es em C permitem dividir o c&oacute;digo em blocos reutiliz&aacute;veis. Voc&ecirc; pode definir suas pr&oacute;prias fun&ccedil;&otilde;es al&eacute;m da <code>main()</code>.</p><div class="dark bg-gray-950 rounded-md border-[0.5px] border-token-border-medium"><div class="overflow-y-auto p-4" dir="ltr"><code class="!whitespace-pre hljs language-c"><span class="hljs-type">void</span> <span class="hljs-title function_">saudacao</span><span class="hljs-params">()</span> { <span class="hljs-built_in">printf</span>(<span class="hljs-string">"Bem-vindo ao curso de C!\n"</span>); } <span class="hljs-type">int</span> <span class="hljs-title function_">main</span><span class="hljs-params">()</span> { saudacao(); <span class="hljs-keyword">return</span> <span class="hljs-number">0</span>; } </code></div></div><p>e) <strong>Arrays:</strong> Arrays s&atilde;o cole&ccedil;&otilde;es de elementos do mesmo tipo. Voc&ecirc; pode declarar e acessar elementos de um array usando &iacute;ndices.</p><div class="dark bg-gray-950 rounded-md border-[0.5px] border-token-border-medium"><div class="overflow-y-auto p-4" dir="ltr"><code class="!whitespace-pre hljs language-c"><span class="hljs-type">int</span> numeros[<span class="hljs-number">5</span>] = {<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>, <span class="hljs-number">4</span>, <span class="hljs-number">5</span>}; <span class="hljs-built_in">printf</span>(<span class="hljs-string">"%d\n"</span>, numeros[<span class="hljs-number">0</span>]); <span class="hljs-comment">// Imprime 1</span> </code></div></div><p>f) <strong>Ponteiros:</strong> Ponteiros s&atilde;o vari&aacute;veis que armazenam o endere&ccedil;o de mem&oacute;ria de outra vari&aacute;vel. Eles s&atilde;o poderosos e essenciais para manipula&ccedil;&atilde;o eficiente de mem&oacute;ria.</p><div class="dark bg-gray-950 rounded-md border-[0.5px] border-token-border-medium"><div class="overflow-y-auto p-4" dir="ltr"><code class="!whitespace-pre hljs language-c"><span class="hljs-type">int</span> numero = <span class="hljs-number">10</span>; <span class="hljs-type">int</span> *p = &amp;numero; <span class="hljs-built_in">printf</span>(<span class="hljs-string">"Valor: %d\n"</span>, *p); <span class="hljs-comment">// Imprime 10</span> </code></div></div><p>g) <strong>Estruturas:</strong> Estruturas (<code>struct</code>) permitem agrupar diferentes tipos de dados sob um &uacute;nico nome.</p><div class="dark bg-gray-950 rounded-md border-[0.5px] border-token-border-medium"><div class="overflow-y-auto p-4" dir="ltr"><code class="!whitespace-pre hljs language-c"><span class="hljs-class"><span class="hljs-keyword">struct</span> <span class="hljs-title">Pessoa</span> {</span> <span class="hljs-type">char</span> nome[<span class="hljs-number">50</span>]; <span class="hljs-type">int</span> idade; }; <span class="hljs-class"><span class="hljs-keyword">struct</span> <span class="hljs-title">Pessoa</span> <span class="hljs-title">pessoa1</span>;</span> pessoa1.idade = <span class="hljs-number">18</span>; </code></div></div><p><strong>Conclus&atilde;o</strong> Aprender C &eacute; uma excelente maneira de entender como o software interage com o hardware. A linguagem C oferece um equil&iacute;brio entre controle de baixo n&iacute;vel e abstra&ccedil;&otilde;es de alto n&iacute;vel, tornando-se uma ferramenta poderosa para qualquer programador. Continue praticando, explorando e construindo coisas incr&iacute;veis com o poder da linguagem C!</p>',
        questions: [
